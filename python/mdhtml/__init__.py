...
__all__ = ["TemplateDelimiter", "MUSTACHE", "JINJA", "mustache_kind", "mustache_code", "mustache_pill", "parse_mdhtml", "to_dom", "to_mdhtml", "render", "blocks", "rewrite", "to_html", "to_md", "math_js", "meta_table", "dialect_css", "theme_css", "themes", "to_typst", "to_pdf", "fill_md"]
...
def to_dom(markdown: str, *, math: str = "brackets", tagfilter: bool = False, bare_autolinks: bool = True, auto_ids: bool = False,
    implicit_figures: bool = False, smart: bool = False, frontmatter: bool = True, templates: Iterable[TemplateDelimiter] | None = None,
    ...
    source, _, _ = _to_mdhtml(markdown, math=math, tagfilter=tagfilter, bare_autolinks=bare_autolinks, auto_ids=auto_ids,
        implicit_figures=implicit_figures, smart=smart, frontmatter=frontmatter, templates=_template_args(templates), callbacks=callbacks,
...
def to_mdhtml(markdown: str, *, math: str = "brackets", tagfilter: bool = False, bare_autolinks: bool = True, auto_ids: bool = False,
    ...
    source, warnings, meta = _to_mdhtml(markdown, math=math, tagfilter=tagfilter, bare_autolinks=bare_autolinks, auto_ids=auto_ids,
        implicit_figures=implicit_figures, smart=smart, frontmatter=frontmatter, templates=_template_args(templates), callbacks=callbacks,
        max_inline_depth=max_inline_depth, max_block_depth=max_block_depth, max_link_paren_depth=max_link_paren_depth)
